...
async def saldo_(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    global ingresos, despeses, estalvi
...
async def despesses_(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global quotes, gastos_diaris, despeses
    despeses = quotes + gastos_diaris
...
async def manejar_gastos_diaris_(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global gastos_diaris, esperando_gastos_diaris
    ...
    if esperando_gastos_diaris:
        try:
            ...
            await update.message.reply_text(f'Has agregado {cantidad}€ a los gastos diarios. Total de gastos diarios: {gastos_diaris}€.')
        except ValueError:
            await update.message.reply_text('Por favor, introduce una cantidad válida.')
...
async def ganancies_(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global ganancies_esporadiques, ganancies_mensuals
    ingresos = ganancies_esporadiques + ganancies_mensuals
...
async def manejar_ganancies_esporadiques_(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global ganancies_esporadiques, esperando_ganancies_esporadiques
    ...
    if esperando_ganancies_esporadiques:
        try:
            ...
            await update.message.reply_text(f'Has agregado {cantidad}€ a las ganancias esporádicas. Total de ganancias esporádicas: {ganancies_esporadiques}€.')
        except ValueError:
            await update.message.reply_text('Por favor, introduce una cantidad válida.')
...
async def manejar_ganancies_mensuals_(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global ganancies_mensuals, esperando_ganancies_mensuals
    ...
    if esperando_ganancies_mensuals:
        try:
            ...
            await update.message.reply_text(f'Has agregado {cantidad}€ a las ganancias mensuales. Total de ganancias mensuales: {ganancies_mensuals}€.')
        except ValueError:
            await update.message.reply_text('Por favor, introduce una cantidad válida.')
